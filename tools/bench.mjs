...
const structuredSatellite = createSatellite(ISS_TLE);
...
const cases = [
  ...
  [
    'SGP4: structured ISS TEME propagation',
    () => structuredSatellite.state(SGP4_INSTANT).r[0],
    'SGP4: ISS TEME propagation'
  ],
