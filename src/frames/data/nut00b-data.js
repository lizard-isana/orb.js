// nut00b-data.js — coefficient table of the IAU 2000B nutation model.
//
// GENERATED from the ERFA library source (nut00b.c); do not edit by hand.
// ERFA is a BSD-licensed derivative of the IAU SOFA library (see
// https://github.com/liberfa/erfa). The underlying model:
// McCarthy & Luzum (2003), "An abridged model of the precession-nutation
// of the celestial pole", Celestial Mechanics 85, 37 -- the official
// 77-term truncation of the IAU 2000A series, accurate to about 1
// milliarcsecond during 1995-2050.
//
// Row layout: [nl, nlp, nf, nd, nom,  ps, pst, pc,  ec, ect, es]
//   nl..nom : integer multipliers of the Delaunay arguments l, l', F, D, Om
//   ps, pst, pc : longitude   sin, t*sin and cos coefficients (0.1 uas)
//   ec, ect, es : obliquity   cos, t*cos and sin coefficients (0.1 uas)

export const NUT00B_TERMS = [
