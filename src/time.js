...
Orb.Time.prototype.time_in_day = function(){
  return this.hours/24 + this.minutes/1440 + this.seconds/86400;
}

Orb.Time.prototype.jd = function(){
  var year = this.year;
...
Orb.Time.prototype.gmst = function(){
...
Orb.Time.prototype.delta_t = function(){
...
Orb.Time.prototype.doy = function(){
  var d=this.date
